package test.endtoend.auctionsniper.driver;

import static auctionsniper.ports.ui.MainWindow.NEW_ITEM_ID_NAME;
import static auctionsniper.ports.ui.MainWindow.NEW_ITEM_STOP_PRICE_NAME;
...
public class AuctionSniperDriver extends JFrameDriver { 
  ...
  public void hasColumnTitles() { 
    JTableHeaderDriver headers = new JTableHeaderDriver(this, 
                                                        JTableHeader.class); 
    headers.hasHeaders( 
       matching(withLabelText("AuctionItem"), withLabelText("Last Price"),
